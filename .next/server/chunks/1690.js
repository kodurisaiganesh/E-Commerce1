...
var iconvLite = __webpack_require__(64209);
...
var Buffer = (__webpack_require__(19884).Buffer);
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(23081) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(47461) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(67307) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(67307).concat)(__webpack_require__(36316)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(67307).concat)(__webpack_require__(36316)) },
        gb18030: function() { return __webpack_require__(56384) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(793) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(33790) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(33790).concat)(__webpack_require__(77452)) },
        encodeSkipVals: [
...
var modules = [
    __webpack_require__(96339),
    __webpack_require__(39348),
    __webpack_require__(48774),
    __webpack_require__(91801),
    __webpack_require__(72153),
    __webpack_require__(1179),
    __webpack_require__(3743),
    __webpack_require__(96192),
    __webpack_require__(19315),
];
...
var bomHandling = __webpack_require__(65771),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(74620); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __webpack_require__(35608)(stream_module);
...
var whatwgUrl = _interopDefault(__webpack_require__(51224));
...
let convert;
try {
	convert = (__webpack_require__(11707)/* .convert */ .O);
} catch (e) {}
...
var mappingTable = __webpack_require__(72738);
...
const usm = __webpack_require__(10222);
...
const conversions = __webpack_require__(61369);
const utils = __webpack_require__(52033);
const Impl = __webpack_require__(10545);
...
exports.URL = __webpack_require__(8386)["interface"];
exports.serializeURL = __webpack_require__(10222).serializeURL;
exports.serializeURLOrigin = __webpack_require__(10222).serializeURLOrigin;
exports.basicURLParse = __webpack_require__(10222).basicURLParse;
exports.setTheUsername = __webpack_require__(10222).setTheUsername;
exports.setThePassword = __webpack_require__(10222).setThePassword;
exports.serializeHost = __webpack_require__(10222).serializeHost;
exports.serializeInteger = __webpack_require__(10222).serializeInteger;
exports.parseURL = __webpack_require__(10222).parseURL;
...
const tr46 = __webpack_require__(11878);
...
function getApp(name = DEFAULT_ENTRY_NAME) {
    ...
    if (!app && name === DEFAULT_ENTRY_NAME && (0,index_node_esm/* getDefaultAppConfig */.aH)()) {
...
/* harmony export */ });
/* unused harmony exports CONSTANTS, DecodeBase64StringError, MAX_VALUE_MILLIS, RANDOM_FACTOR, Sha1, areCookiesEnabled, assert, assertionError, async, base64, base64Decode, base64Encode, calculateBackoffMillis, contains, createSubscribe, decode, deepCopy, deepExtend, errorPrefix, extractQuerystring, getDefaultEmulatorHost, getDefaults, getExperimentalSetting, getGlobal, getUA, isAdmin, isBrowser, isBrowserExtension, isElectron, isEmpty, isIE, isMobileCordova, isNodeSdk, isReactNative, isSafari, isUWP, isValidFormat, isValidTimestamp, issuedAtTime, jsonEval, map, ordinal, promiseWithTimeout, querystring, querystringDecode, safeGet, stringLength, stringToByteArray, stringify, uuidv4, validateArgCount, validateCallback, validateContextObject, validateNamespace */
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
/* harmony export */ });
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64510);
 ...
 * @public
 */
class StorageError extends index_node_esm/* FirebaseError */.ZR {
    /**
...
function isNativeBlobDefined() {
    ...
    return typeof Blob !== 'undefined' && !(0,index_node_esm/* isNode */.UG)();
}
 ...
 */
function index_node_esm_parent(path) {
    if (path.length === 0) {
        return null;
    }
 ...
 */
// eslint-disable-next-line @typescript-eslint/ban-types
function index_node_esm_async(f) {
...
class FetchBytesConnection extends (/* unused pure expression or super */ null && (FetchConnection)) {
    getResponse() {
        if (!this.body_) {
...
class FetchStreamConnection extends (/* unused pure expression or super */ null && (FetchConnection)) {
    constructor() {
        super(...arguments);
        this.stream_ = null;
    }
        ...
        if (this._resolve !== undefined) {
            ...
            switch (taskStateFromInternalTaskState(this._state)) {
                case TaskState.SUCCESS:
                    index_node_esm_async(this._resolve.bind(null, this.snapshot))();
                    break;
                case TaskState.CANCELED:
                case TaskState.ERROR:
                    const toCall = this._reject;
                    index_node_esm_async(toCall.bind(null, this._error))();
                    break;
                default:
                    triggered = false;
                    break;
    ...
    _notifyObserver(observer) {
        ...
        switch (externalState) {
            ...
            case TaskState.PAUSED:
                if (observer.next) {
                    index_node_esm_async(observer.next.bind(observer, this.snapshot))();
                }
                break;
            case TaskState.SUCCESS:
                if (observer.complete) {
                    index_node_esm_async(observer.complete.bind(observer))();
                }
                break;
            case TaskState.CANCELED:
            case TaskState.ERROR:
                if (observer.error) {
                    index_node_esm_async(observer.error.bind(observer, this._error))();
                }
                break;
            default:
                // TODO(andysoto): assert(false);
...
class Reference {
     ...
     */
    get parent() {
        const newPath = index_node_esm_parent(this._location.path);
        if (newPath === null) {
            return null;
        }
    ...
    if (mockUserToken) {
        storage._overrideAuthToken =
            typeof mockUserToken === 'string'
                ? mockUserToken
                : (0,index_node_esm/* createMockUserToken */.Sg)(mockUserToken, storage.app.options.projectId);
    }
}
/**
...
function uploadBytesResumable(ref, data, metadata) {
    ref = (0,index_node_esm/* getModularInstance */.m9)(ref);
...
function ref(serviceOrRef, pathOrUrl) {
    serviceOrRef = (0,index_node_esm/* getModularInstance */.m9)(serviceOrRef);
 ...
 */
function getStorage(app = (0,index_esm2017/* getApp */.Mq)(), bucketUrl) {
    app = (0,index_node_esm/* getModularInstance */.m9)(app);
    const storageProvider = (0,index_esm2017/* _getProvider */.qX)(app, STORAGE_TYPE);
    const storageInstance = storageProvider.getImmediate({
        identifier: bucketUrl
    });
    const emulator = (0,index_node_esm/* getDefaultEmulatorHostnameAndPort */.P0)('storage');
    if (emulator) {
...
function factory(container, { instanceIdentifier: url }) {
    ...
    return new FirebaseStorageImpl(app, authProvider, appCheckProvider, url, index_esm2017/* SDK_VERSION */.Jn);
}
function registerStorage() {
    (0,index_esm2017/* _registerComponent */.Xd)(new esm_index_esm2017/* Component */.wA(STORAGE_TYPE, factory, "PUBLIC" /* ComponentType.PUBLIC */).setMultipleInstances(true));
    (0,index_esm2017/* registerVersion */.KN)(index_node_esm_name, version);
}
registerStorage();
...
;// CONCATENATED MODULE: ./node_modules/firebase/storage/dist/index.mjs
