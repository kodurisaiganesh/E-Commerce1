      ...
      <section className="">
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-bold text-red-500 lg:mb-8 md:text-lg lg:text-xl">
          ...
          <div className="hidden lg:mt-35 lg:col-span-5 lg:flex">
            <img
              src="https://assets.materialup.com/uploads/50b1ef30-159f-4188-9b03-cecefa107fba/preview.jpg"
          ...
          <ul className="grid grid-cols-1 gap-4 mt-8 lg:grid-cols-3">
            <li>
              <div className="relative block group">
                <img
                  src="https://i.pinimg.com/originals/75/23/c8/7523c85b903f9af674014973e1d2acd7.jpg"
            ...
            <li>
              <div className="relative block group">
                <img
                  src="https://www.aachho.com/cdn/shop/files/Republic-1A_300x.png?v=1705914338"
                  className="object-cover w-full aspect-square"
                />
                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
            ...
            <li className="lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-1">
              <div className="relative block group">
                <img
                  src="https://i.pinimg.com/originals/f8/99/cf/f899cf296b79c35701444606c9d8fc1f.jpg"
                  className="object-cover w-full aspect-square"
                />
                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
